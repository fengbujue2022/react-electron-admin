...
const fetchData = async (page: number, rowsPerPage: number, selectedOption?: DataModel.Reporter) => {
  let result: RowReturnType<DataModel.Reporter>
  try {
    if (selectedOption) {
      result = await ReporterRepository.getPagingList(rowsPerPage, page, (query) => {
